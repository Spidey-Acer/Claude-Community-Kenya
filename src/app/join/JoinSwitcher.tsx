      ...
      <div className="mx-auto max-w-6xl">
            ...
            <TerminalWindow title="community-pulse" variant="command">
              <div className="text-center">
                ...
                <div className="mb-4 flex flex-wrap items-center justify-center gap-4 font-mono text-lg text-text-primary sm:gap-6 sm:text-xl">
                  ...
                  <span>
                    <CountUp target={3} className="font-bold text-amber" /> meetups held
                  </span>
                  <span className="text-text-dim" aria-hidden="true">•</span>
                  <span>
                    <CountUp target={2} className="font-bold text-cyan" /> cities
                  </span>
                  <span className="text-text-dim" aria-hidden="true">•</span>
                  <span>
                    <CountUp target={33} className="font-bold text-text-primary" /> resources
                  </span>
                </div>
        ...
        <ScrollReveal>
          <section id="contribute" className="mb-16 scroll-mt-24">
            <h2 className="mb-8 text-center font-mono text-2xl font-bold text-cyan">Contribute</h2>
            <div className="mb-8 grid grid-cols-1 gap-6 md:grid-cols-2">
              ...
              <Link href={`mailto:${CONTACT.email}?subject=Help%20Organize%20CCK`} className="block">
                <Card title="organize.sh" padding="md" className="cursor-pointer">
                  <h3 className="mb-2 font-mono text-lg font-bold text-text-primary">Help Organize</h3>
                  <p className="font-sans text-text-secondary">
              ...
              <Link href="/submit-idea" className="block">
                <Card title="submit.sh" padding="md" className="cursor-pointer">
                  <h3 className="mb-2 font-mono text-lg font-bold text-text-primary">Submit a Project</h3>
                  <p className="font-sans text-text-secondary">
            ...
            <div className="border border-border-default bg-bg-secondary p-6">
              <p className="font-mono text-sm text-text-dim">
                <span className="text-green-primary" aria-hidden="true">$ </span>
                Get in touch:{" "}
                <a
