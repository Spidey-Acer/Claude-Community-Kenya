 ...
 *
 * `?cohort=&teamId=&size=square|portrait|story` (plus `announcementMode`,
 * `announced`, `announcedTrackWinnerIds` pre-publish). Served inline, never
 * cached: the whole point is to see the current state.
 */
...
export async function GET(request: NextRequest) {
  ...
  const image = await renderCard(team.card, size)
